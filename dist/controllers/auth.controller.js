...
const auth_local_gaurd_1 = require("../config/auth-local.gaurd");
...
let AuthController = class AuthController {
    ...
    async verifyCode(body) {
        if (body.code === 0) {
            throw new common_1.UnauthorizedException('Verification code can not be 0');
        }
...
__decorate([
    (0, common_1.UseGuards)(auth_local_gaurd_1.LocalAuthGaurd),
